...
var MapVRenderer$1 = function (_BaseLayer) {
  ...
  function MapVRenderer(viewer, dataset, option, mapVLayer) {
    ...
    _this.map = viewer, _this.scene = viewer.scene, _this.dataSet = dataset;option = option || {}, _this.init(option), _this.argCheck(option), _this.initDevicePixelRatio(), _this.canvasLayer = mapVLayer, _this.stopAniamation = !1, _this.animation = option.animation, _this.clickEvent = _this.clickEvent.bind(_this), _this.mousemoveEvent = _this.mousemoveEvent.bind(_this), _this.bindEvent();
    return _this;
  }
